...
const PATHS = {
  ...
  settings: '<circle cx="12" cy="12" r="3"/><path d="M12 3.5 13 6l2.6-.6 1.4 2.4-1.8 2 1.8 2-1.4 2.4L13 18l-1 2.5h-2L9 18l-2.6.6L5 16.2l1.8-2-1.8-2 1.4-2.4L9 6l1-2.5z"/>',
